          ...
          <ContentHeadRow className="content">
            <Col mdPush={3} md={6} className="text-center" style={{ paddingBottom: '15px' }}>
              <span>
                ...
                <a target="_blank" rel="noopener noreferrer" href="https://gettingstarted.alertmanager/assets/index.html">AlertManager Getting Started Guide</a>.
      ...
      if (!guideLoaded) {
        spinner = (
          <Grid>
            <ContentHeadRow className="content">
              <Col mdPush={3} md={6} className="text-center" style={{ paddingBottom: '15px' }}>
                <Spinner text="Loading AlertManager Getting started guide ..." />
              </Col>
            </ContentHeadRow>
          </Grid>
        );
