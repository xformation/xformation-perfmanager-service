...
describe('ShowMessagePage', () => {
  it('triggers a node list refresh on mount', async () => {
    ...
    // @ts-ignore
    render(<ShowMessagePage params={{ index: 'alertmanager_5', messageId: '20f683d2-a874-11e9-8a11-0242ac130004' }} />);
  ...
  it('renders for generic message', async () => {
    ...
    mockGetInput.mockImplementation(() => Promise.resolve(input));
    // @ts-ignore
    const { container, queryByTestId } = render(<ShowMessagePage params={{ index: 'alertmanager_5', messageId: '20f683d2-a874-11e9-8a11-0242ac130004' }} />);
