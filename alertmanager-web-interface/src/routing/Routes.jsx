...
const defaultExport = AppConfig.xfalertAppPathPrefix() ? qualifyUrls(Routes, AppConfig.xfalertAppPathPrefix()) : Routes;
...
defaultExport.pluginRoute = (routeKey, throwError = true) => {
  ...
  const route = (AppConfig.xfalertAppPathPrefix() ? qualifyUrls(pluginRoutes, AppConfig.xfalertAppPathPrefix()) : pluginRoutes)[routeKey];
