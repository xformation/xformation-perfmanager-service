...
public class LegacyMongoIndexRangeServiceTest {
    ...
    public void testGetExistingIndexRange() throws Exception {
        final IndexRange indexRange = indexRangeService.get("alertmanager_0");
        final DateTime end = new DateTime(2015, 1, 1, 0, 0, 0, 0, DateTimeZone.UTC);
        final IndexRange expected = MongoIndexRange.create(new ObjectId("56250da2d400000000000001"), "alertmanager_0", EPOCH, end, end, 0);
    ...
    public void testGetIncompleteIndexRange() throws Exception {
        final IndexRange indexRange = indexRangeService.get("alertmanager_99");
        final DateTime end = new DateTime(2015, 1, 1, 0, 0, 0, 0, DateTimeZone.UTC);
        final IndexRange expected = MongoIndexRange.create(new ObjectId("56250da2d400000000000099"), "alertmanager_99", EPOCH, end, EPOCH, 0);
        assertThat(indexRange).isEqualTo(expected);
    }
    ...
    public void testFindAll() throws Exception {
        ...
        assertThat(indexRanges).containsExactly(
                MongoIndexRange.create(new ObjectId("56250da2d400000000000001"), "alertmanager_0", EPOCH, end0, end0, 0),
                MongoIndexRange.create(new ObjectId("56250da2d400000000000099"), "alertmanager_99", EPOCH, end99, EPOCH, 0),
                MongoIndexRange.create(new ObjectId("56250da2d400000000000002"), "alertmanager_1", EPOCH, end1, end1, 1),
                MongoIndexRange.create(new ObjectId("56250da2d400000000000003"), "alertmanager_2", EPOCH, end2, end2, 2)
        );
    }
    ...
    public void testCalculateRange() throws Exception {
        indexRangeService.calculateRange("alertmanager_0");
    }
    ...
    public void testDelete() throws Exception {
        ...
        indexRangeService.delete("alertmanager_1");
