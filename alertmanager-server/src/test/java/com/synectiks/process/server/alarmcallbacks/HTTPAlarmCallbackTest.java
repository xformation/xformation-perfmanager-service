...
public class HTTPAlarmCallbackTest {
    ...
    public void callSucceedsIfRemoteRequestSucceeds() throws Exception {
        ...
        final List<MessageSummary> messageSummaries = ImmutableList.of(
                new MessageSummary("alertmanager_1", new Message("Test message 1", "source1", new DateTime(2016, 9, 6, 17, 0, DateTimeZone.UTC))),
                new MessageSummary("alertmanager_2", new Message("Test message 2", "source2", new DateTime(2016, 9, 6, 17, 0, DateTimeZone.UTC)))
        );
