...
public class MongoIndexRangeServiceTest {
    ...
    public void getReturnsExistingIndexRange() throws Exception {
        IndexRange indexRange = indexRangeService.get("alertmanager_1");

        assertThat(indexRange.indexName()).isEqualTo("alertmanager_1");
    ...
    public void getIgnoresLegacyIndexRange() throws Exception {
        indexRangeService.get("alertmanager_0");
    }
     ...
     * <pre>
     *                        [-        index range       -]
     * [- alertmanager_1 -][- alertmanager_2 -][- alertmanager_3 -][- alertmanager_4 -][- alertmanager_5 -]
     * </pre>
     */
    @Test
    ...
    public void findReturnsIndexRangesWithinGivenRange() throws Exception {
        ...
        assertThat(indexRanges).containsExactly(
                MongoIndexRange.create(new ObjectId("55e0261a0cc6980000000002"), "alertmanager_2", new DateTime(2015, 1, 2, 0, 0, DateTimeZone.UTC), new DateTime(2015, 1, 3, 0, 0, DateTimeZone.UTC), new DateTime(2015, 1, 3, 0, 0, DateTimeZone.UTC), 42),
                MongoIndexRange.create(new ObjectId("55e0261a0cc6980000000003"), "alertmanager_3", new DateTime(2015, 1, 3, 0, 0, DateTimeZone.UTC), new DateTime(2015, 1, 4, 0, 0, DateTimeZone.UTC), new DateTime(2015, 1, 4, 0, 0, DateTimeZone.UTC), 42),
                MongoIndexRange.create(new ObjectId("55e0261a0cc6980000000004"), "alertmanager_4", new DateTime(2015, 1, 4, 0, 0, DateTimeZone.UTC), new DateTime(2015, 1, 5, 0, 0, DateTimeZone.UTC), new DateTime(2015, 1, 5, 0, 0, DateTimeZone.UTC), 42)
        );
    }
    ...
    public void findIgnoresLegacyIndexRanges() throws Exception {
        ...
        assertThat(indexRanges).containsOnly(
                MongoIndexRange.create(new ObjectId("55e0261a0cc6980000000003"), "alertmanager_1", new DateTime(2015, 1, 1, 0, 0, DateTimeZone.UTC), new DateTime(2015, 1, 2, 0, 0, DateTimeZone.UTC), new DateTime(2015, 1, 2, 0, 0, DateTimeZone.UTC), 42)
        );
    }
    ...
    public void remove() throws Exception {
        ...
        assertThat(indexRangeService.remove("alertmanager_1")).isTrue();
        assertThat(indexRangeService.remove("alertmanager_1")).isFalse();
    ...
    public void testHandleIndexDeletion() throws Exception {
        when(indexSetRegistry.isManagedIndex("alertmanager_1")).thenReturn(true);

        assertThat(indexRangeService.findAll()).hasSize(2);

        localEventBus.post(IndicesDeletedEvent.create(Collections.singleton("alertmanager_1")));
    ...
    public void testHandleIndexClosing() throws Exception {
        ...
        localEventBus.post(IndicesClosedEvent.create(Collections.singleton("alertmanager_1")));
    ...
    public void testHandleIndexReopening() throws Exception {
        ...
        when(indices.indexRangeStatsOfIndex("alertmanager_3")).thenReturn(IndexRangeStats.create(begin, end));
        when(indexSetRegistry.isManagedIndex("alertmanager_3")).thenReturn(true);

        localEventBus.post(IndicesReopenedEvent.create(Collections.singleton("alertmanager_3")));

        final SortedSet<IndexRange> indexRanges = indexRangeService.find(begin, end);
        assertThat(indexRanges).hasSize(1);
        assertThat(indexRanges.first().indexName()).isEqualTo("alertmanager_3");
    ...
    public void testHandleIndexReopeningWhenNotManaged() throws Exception {
        final DateTime begin = new DateTime(2016, 1, 1, 0, 0, DateTimeZone.UTC);
        final DateTime end = new DateTime(2016, 1, 15, 0, 0, DateTimeZone.UTC);
        when(indexSetRegistry.isManagedIndex("alertmanager_3")).thenReturn(false);
        when(indices.indexRangeStatsOfIndex("alertmanager_3")).thenReturn(IndexRangeStats.EMPTY);
