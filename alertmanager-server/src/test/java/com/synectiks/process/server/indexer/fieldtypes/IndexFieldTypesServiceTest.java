...
public class IndexFieldTypesServiceTest {
    ...
    public void saveGetDeleteStream() {
        final IndexFieldTypesDTO newDto1 = createDto("alertmanager_0", Collections.emptySet());
        final IndexFieldTypesDTO newDto2 = createDto("alertmanager_1", Collections.emptySet());
        ...
        assertThat(dto1.indexName()).isEqualTo("alertmanager_0");
    ...
    public void upsert() {
        ...
        assertThat(upsertedDto1.indexName()).isEqualTo("alertmanager_0");
        assertThat(upsertedDto2.indexName()).isEqualTo("alertmanager_1");
    ...
    public void streamForIndexSet() {
        final IndexFieldTypesDTO newDto1 = createDto("alertmanager_0", "abc", Collections.emptySet());
        final IndexFieldTypesDTO newDto2 = createDto("alertmanager_1", "xyz", Collections.emptySet());
        final IndexFieldTypesDTO newDto3 = createDto("alertmanager_2", "xyz", Collections.emptySet());
    ...
    public void streamForFieldNames() throws Exception {
        dbService.save(createDto("alertmanager_0", "abc", Collections.emptySet()));
        dbService.save(createDto("alertmanager_1", "xyz", Collections.emptySet()));
        dbService.save(createDto("alertmanager_2", "xyz", Collections.emptySet()));
        dbService.save(createDto("alertmanager_3", "xyz", of(
    ...
    public void streamForFieldNamesAndIndices() throws Exception {
        ...
        assertThat(dbService.findForFieldNamesAndIndices(
                of("message", "yolo1"),
                of("alertmanager_1", "alertmanager_3")
        ).size()).isEqualTo(2);

        assertThat(dbService.findForFieldNamesAndIndices(
                of("message", "yolo1"),
                of("alertmanager_1", "alertmanager_3", "alertmanager_0")
        ).size()).isEqualTo(3);
    }
}
