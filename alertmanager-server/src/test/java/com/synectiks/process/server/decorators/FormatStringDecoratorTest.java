...
public class FormatStringDecoratorTest {
    ...
    private SearchResponse getSearchResponse() {
        ...
        final List<ResultMessageSummary> messages = ImmutableList.of(
                create(hlRanges, ImmutableMap.of("_id", "h", "field_a", "1", "field_b", "b"), "alertmanager_0"),
                create(hlRanges, ImmutableMap.of("_id", "h", "field_a", "1"), "alertmanager_0"),
                create(hlRanges, ImmutableMap.of("_id", "h", "field_b", "b"), "alertmanager_0"),
                create(hlRanges, ImmutableMap.of("_id", "i", "foo", "1"), "alertmanager_0")
        );
