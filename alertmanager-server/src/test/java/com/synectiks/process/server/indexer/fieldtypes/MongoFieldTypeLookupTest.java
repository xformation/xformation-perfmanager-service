...
public class MongoFieldTypeLookupTest {
    ...
    public void getSingleField() {
        ...
        assertThat(result.types()).containsOnly(FieldTypes.Type.builder()
                ...
                .indexNames(of("alertmanager_0", "alertmanager_1", "alertmanager_2", "alertmanager_3"))
                .build());
    }
    ...
    public void getMultipleFields() {
        dbService.save(createDto("alertmanager_0", "abc", Collections.emptySet()));
        dbService.save(createDto("alertmanager_1", "xyz", Collections.emptySet()));
        dbService.save(createDto("alertmanager_2", "xyz", of(
        ...
        assertThat(result.get("yolo1").types()).containsOnly(
                FieldTypes.Type.builder()
                        .type("string")
                        .properties(of("full-text-search"))
                        .indexNames(of("alertmanager_3"))
                        .build(),
                FieldTypes.Type.builder()
                        .type("boolean")
                        .properties(of("enumerable"))
                        .indexNames(of("alertmanager_2"))
                        .build()
        );
    ...
    public void getMultipleFieldsWithIndexScope() {
        ...
        final Map<String, FieldTypes> result = lookup.get(of("yolo1", "timestamp"), of("alertmanager_1", "alertmanager_2"));
        ...
        assertThat(result.get("timestamp").types()).containsOnly(FieldTypes.Type.builder()
                .type("date")
                .properties(of("enumerable"))
                .indexNames(of("alertmanager_1", "alertmanager_2"))
                .build());
    }
}
