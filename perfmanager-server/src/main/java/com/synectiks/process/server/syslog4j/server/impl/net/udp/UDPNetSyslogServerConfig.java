package com.synectiks.process.server.syslog4j.server.impl.net.udp;

import com.synectiks.process.server.syslog4j.SyslogConstants;
import com.synectiks.process.server.syslog4j.server.impl.net.AbstractNetSyslogServerConfig;
